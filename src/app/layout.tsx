      ...
      <body>
        ...
        <div className="flex min-h-screen">
          ...
          <div className="min-w-0 flex-1">
            <header
              className="sticky top-0 z-50 flex items-center justify-between gap-3 border-b px-5 py-3 backdrop-blur"
              style={{ borderColor: "var(--line-soft)", background: "rgba(10,13,16,0.8)" }}
            >
              <div className="flex items-center gap-2 md:hidden">
                <MobileNav />
                <div className="display text-sm font-bold tracking-tight">
                  JOB<span style={{ color: "var(--amber)" }}>PILOT</span>
                </div>
              </div>
