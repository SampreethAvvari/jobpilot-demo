  ...
  return (
    <div className="rise mx-auto max-w-3xl" data-tour="run-your-own">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {FEATURES.map(([title, blurb]) => (
          <div key={title} className="card p-4">
            <div className="font-bold" style={{ color: "var(--ink)" }}>{title}</div>
            <p className="mt-1 text-[11px] leading-4" style={{ color: "var(--ink-55)" }}>
              {blurb}
            </p>
          </div>
        ))}
      ...
      <div className="card mt-6 p-5">
        ...
        <p className="mt-2 text-xs leading-5" style={{ color: "var(--ink-55)" }}>
          Roughly <b style={{ color: "var(--ink)" }}>$0 to $10 a month</b>: Cloud Run
      ...
      <div className="mt-6">
        ...
        <pre
          className="card overflow-x-auto p-4 text-[11px] leading-5"
          style={{ whiteSpace: "pre-wrap", color: "var(--ink-55)" }}
        >
          {AGENT_PROMPT}
        </pre>
        <p className="mt-2 text-[11px]" style={{ color: "var(--ink-35)" }}>
      ...
      <div className="mt-6 flex flex-wrap gap-3 text-xs">
        <a className="btn btn-primary px-4 py-2" href="https://github.com/SampreethAvvari/job-pilot"
      ...
      <p className="mt-8 text-[11px]" style={{ color: "var(--ink-35)" }}>
